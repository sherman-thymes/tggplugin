...
class TGGPLUGIN
{
	...
	public function TGGPLUGIN_ACTIVATE(){
		...
		$options['TGGPLUGIN_TWITTERKEY1'] = TGGPLUGIN_ENCRYPT('', constant('TGGPLUGIN_PLUGINKEY'));
		$options['TGGPLUGIN_TWITTERKEY2'] = TGGPLUGIN_ENCRYPT('', constant('TGGPLUGIN_PLUGINKEY'));
		$options['TGGPLUGIN_TWITTERKEY3'] = TGGPLUGIN_ENCRYPT('', constant('TGGPLUGIN_PLUGINKEY'));
		$options['TGGPLUGIN_TWITTERKEY4'] = TGGPLUGIN_ENCRYPT('', constant('TGGPLUGIN_PLUGINKEY'));
